...
struct MetadataController {
    ...
    func metadata(_ req: Request) async throws -> Metadata.Response {
        ...
        guard let token = try await req.challengeTokens.find(value: request.attestation.challenge),
        ...
        try await req.challengeTokens.delete(id: token.requireID())
    ...
    func challenge(_ req: Request) async throws -> Attestation.Challenge.Response {
        ...
        try await req.challengeTokens.create(model)
